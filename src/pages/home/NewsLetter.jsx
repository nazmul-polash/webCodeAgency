   ...
   return (
      <section className="container-section">
         ...
         <div className="flex flex-col items-center justify-center text-center">
            <HeadingSection  subHeading="" heading="Stay Updated with Our Newsletter" headingDesc="Subscribe to our newsletter to get the latest news, updates, and offers. Rhoncus morbi et augue nec, in id ullamcorper at sit. Condimentum sit nunc in eros scelerisque sed. Commodo in viverra nunc, ullamcorper ut. Non, amet, aliquet scelerisque nullam sagittis, pulvinar." />
